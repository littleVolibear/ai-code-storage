...
public class RoomObjectHis {
    private Integer roomObjectId; // 对象 ID
    ...
    private Integer objProtoId; // 对象原型 ID
    private String side; // 推演方
    private String objName; // 棋子名称
    @TableField("ICON_3D")
    private String icon3d; // 三维图标
    @TableField("ICON_2D")
    private String icon2d; // 二维图标
    ...
    private String carryingObjList; // 可装载对象列表
    private String operatorId; // 用户ID
    private Integer objCurrentVehicleNum; // 当前载具数
    private Integer objParentId; // 父棋子ID
    private Integer aiInterface; // AI 接口标识
    private String objSonNum; // 当前下级对象数量
    private Integer objSonOriginalId; // 下级对象原始 ID
    ...
    private Integer hideStatus; // 隐藏状态
    private Integer firingOrMarching; // 射击或机动状态
    private Integer combatHeight; // 作战高度
    private Integer weaponId; // 当前武器 ID
    private Integer weaponRange; // 当前武器射程
    private Integer weaponNum; // 当前武器数量
    private Integer fortObjId; // 关联工事对象 ID
